                        ...
                        <div class="col-8">
                            <div class="numbers">
                                ...
                                <h5 class="font-weight-bolder mb-0">
                                    ...
                                    <span class="text-success text-sm font-weight-bolder">{{ round($userPercentage, 2) }}%</span>
                                </h5>
                            </div>
                        </div>
                        <div class="col-4 text-end">
                        ...
                        <div class="col-8">
                            <div class="numbers">
                                ...
                                <h5 class="font-weight-bolder mb-0">
                                    ...
                                    <span class="text-success text-sm font-weight-bolder">{{ round($kontenPercentage, 2) }}%</span>
                                </h5>
                            </div>
                        </div>
                        <div class="col-4 text-end">
                        ...
                        <div class="col-8">
                            <div class="numbers">
                                ...
                                <h5 class="font-weight-bolder mb-0">
                                    ...
                                    <span class="text-success text-sm font-weight-bolder">{{ round($artikelPercentage, 2) }}%</span>
                                </h5>
                            </div>
                        </div>
                        <div class="col-4 text-end">
